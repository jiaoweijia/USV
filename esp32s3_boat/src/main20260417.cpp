...
//   delay(1000);
//   ledcWrite(PWM_L_CHANNEL, convertPWM_double(1300));
//   ledcWrite(PWM_R_CHANNEL, convertPWM_double(1300));
//   delay(2000);
//   ledcWrite(PWM_L_CHANNEL, convertPWM_double(1700));
//   ledcWrite(PWM_R_CHANNEL, convertPWM_double(1700));
//   delay(2000);
//   ledcWrite(PWM_L_CHANNEL, convertPWM_double(1500));
//   ledcWrite(PWM_R_CHANNEL, convertPWM_double(1500));
//   delay(1000);
