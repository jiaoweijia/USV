...
// IPAddress serverIP(192, 168, 6, 10);   // 电脑服务器IP地址
// IPAddress piServerIP(192, 168, 6, 11); // 树莓派服务器IP地址
...
//         // 构造JSON数据
//         String jsonData = "{\"adc0\":"; 
//         jsonData += String(adcValue);
//         jsonData += ",\"temperature\":";
//         jsonData += String(temperature, 1); // 保留1位小数
//         jsonData += "}";
...
//         }
//         jsonData += ",\"led_left\":";
//         jsonData += String(led_left_state);
//         jsonData += ",\"led_right\":";
//         jsonData += String(led_right_state);
//         jsonData += "}";
//         sendUdpMessage(jsonData);
...
//   Serial.begin(115200);
//   Serial.println("ESP32 UDP 无刷电机+舵机+摄像头控制启动中...");
