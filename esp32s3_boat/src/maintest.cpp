...
// unsigned int serverPort = 8000;       // 电脑服务器端port
// unsigned int piServerPort = 8000;     // 树莓派服务器端port
// unsigned int localPort = 8080;        // 本地端port
// unsigned int cameraPort = 8888;       // 相机传输端port
